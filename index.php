...
<!--- it was here --->
<script type="text/javascript" src="rpgchat.js"></script>
<TABLE class=t1>
  <TR class=tr><TD id=c-chat>
...
<DIV id=main-map>
  <IMG id=map-image title='map loading...'>
  <DIV class=map-button-container>
    <A href='javascript:hideMap()' class='menu-title menu-button map-button'>Close</A>
  </DIV>
  <DIV class=player-tag id=player0>player0</DIV>
  <DIV class=player-tag id=player1>player0</DIV>
  <DIV class=player-tag id=player2>player0</DIV>
  <DIV class=player-tag id=player3>player0</DIV>
  <DIV class=player-tag id=player4>player0</DIV>
  <DIV class=player-tag id=player5>player0</DIV>
  <DIV class=player-tag id=player6>player0</DIV>
  <DIV class=player-tag id=player7>player0</DIV>
  <DIV class=player-tag id=player8>player0</DIV>
  <DIV class=player-tag id=player9>player0</DIV>
  <?php
  	if($GM_MODE_ON) {
		echo '<A class=map-button href="javascript:gmMapPlus()">+</A> ';
		echo '<A class=map-button href="javascript:gmMapMinus()">-</A> ';
		echo '<A class=map-button href="javascript:gmMapLeft()">left</A> ';
		echo '<A class=map-button href="javascript:gmMapRight()">right</A> ';
		echo '<A class=map-button href="javascript:gmMapUp()">up</A> ';
		echo '<A class=map-button href="javascript:gmMapDown()">down</A> ';
    	echo '<A class=map-button href="javascript:gmMapSave()">save</A> ';
    	echo '<SELECT name=player-tag id=player-tags>';
    	//foreach($playerTags as $pt) {
		//	echo "<OPTION>$pt</OPTION>";
    	//}//for
    	echo '</SELECT><A class=map-button href="javascript:savePlayerTag()">mark</A>';
  	}//if
  ?>
</DIV>
</body>
